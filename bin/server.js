...
var
  ...
  http = require('http'),
  posix = require('posix'),
  Mustache = require('dep/node-mustache'),
  middleware = {
...
http.createServer(
  (fab)
    ...
    ('/admin')
      ...
      ('/comments')
        ['GET'](function(respond) {
          return deliverComments.call(this, respond, 'pending');
        })
    ...
    .addListener('change', function(change) {
      ...
      db
        ...
        .addCallback(function(doc) {
          ...
          //
          //
          var doc_ids = comments.map(function(comment, i){
            return comment._id;
          });
          
          var found = null;
          doc_ids.map(function(comment,i){
            if(doc._id == comment){
              found = true;
            }
          });
